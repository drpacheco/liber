jQuery(document).ready(function() {
	...
	function adicionar_parcela() {
		$(function() {
			dias = $('#PesquisaPagamentoTipoItemDiasIntervaloParcela').val();
			...
			'<tr>'+
				...
				'<td> <input type="text" name="data[PagamentoTipoItem]['+numero_campo+'][dias_intervalo_parcela]" value="'+dias+'" class="noinput dias_intervalo_parcela" /> </td>'+
			...
			limpar_pesquisa();
			$('#PesquisaPagamentoTipoItemDiasIntervaloParcela').focus();
		});
	}
