...
<?php
if ($this->Ajax->isAjax()) {
	print $this->Ajax->form('cadastrar','post',array('autocomplete'=>'off','model'=>'FormaPagamento','update'=>'conteudo_ajax'));
}
else {
...
<div class="grupo_horizontal">
	<?php print $this->Form->input('tipo_documento_id',array('label'=>'Documento','options'=>$opcoes_documentos)); ?>
</div>
<div class="grupo_horizontal">
	<?php print $this->Form->input('conta_principal',array('label'=>'Conta principal','options'=>$opcoes_contas)); ?>
</div>
