...
<div class="<?php echo $pluralVar;?> index">
	...
	echo "\t<tr<?php echo \$class;?>>\n";
		...
		echo "\t\t\t<?php echo \$this->Html->link(__('Ver'), array('action' => 'view', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?>\n";
	 	...
	 	echo "\t\t\t<?php echo \$this->Html->link(__('Excluir'), array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), null, sprintf(__('Você tem certeza que deseja excluir o id #%s?'), \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?>\n";
		echo "\t\t</td>\n";
	echo "\t</tr>\n";
	...
	<div class="paging">
	<?php echo "\t<?php echo \$this->Paginator->prev('<< '.__('anterior'), array(), null, array('class'=>'disabled'));?>\n";?>
	 | <?php echo "\t<?php echo \$this->Paginator->numbers();?>\n"?> |
	<?php echo "\t<?php echo \$this->Paginator->next(__('próxima').' >>', array(), null, array('class' => 'disabled'));?>\n";?>
	</div>
</div>
<div class="actions">
	<h3><?php echo "<?php echo __('Ações'); ?>"; ?></h3>
	<ul>
		<li><?php echo "<?php echo \$this->Html->link(sprintf(__('Novo %s'), __('" . Inflexao::acentos($singularHumanName) . "')), array('action' => 'add')); ?>";?></li>
<?php
	$done = array();
