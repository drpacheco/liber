...
<?php
	...
	if (!empty(\$settings)):
		echo '<span class=\"notice success\">';
				printf(__('O %s está sendo usado para cache. Para alterar, edite o arquivo APP/config/core.php.'), '<em>'. \$settings['engine'] . 'Engine</em>');
		echo '</span>';
	else:
		echo '<span class=\"notice\">';
...
$output .= "<?php endif;?>\n";
$output .= "<h3><?php echo __('Editando esta página') ?></h3>\n";
$output .= "<p>\n";
$output .= "<?php\n";
