<h2 class="descricao_cabecalho">Cadastrar motorista</h2>

<?php
if ($ajax->isAjax()) {
	print $ajax->form('cadastrar','post',array('autocomplete'=>'off','model'=>'Motorista','update'=>'conteudo_ajax'));

}
else {
	print $form->create('Motorista',array('autocomplete'=>'off','onsubmit'=>'submissaoFormulario(this); return false;'));
}
?>
<div class="divs_grupo_2">
	...
	<div class="div2_2">
		...
		print $form->input('veiculo_padrao',array('label'=>'Principal veículo','options'=>$opcoes_veiculo));
		?>
	</div>
</div>
