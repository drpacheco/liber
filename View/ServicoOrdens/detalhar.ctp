...
<fieldset>
	...
	<div class="grupo_horizontal">
		<label>Data e hora do registro </label> <input class="noinput" value="<?php print $this->Formatacao->dataHora($c['ServicoOrdem']['data_hora_cadastrada']);?>" />
	</div>
	<div class="grupo_horizontal"> 
	...
	<div class="grupo_horizontal">
		<label>Início</label> <input class="noinput" value="<?php print $this->Formatacao->dataHora($c['ServicoOrdem']['data_hora_inicio']) ;?>" />
	</div>
	<div class="grupo_horizontal">
		<label>Fim </label> <input class="noinput" value="<?php print $this->Formatacao->dataHora($c['ServicoOrdem']['data_hora_fim']);?>" />
	</div>
</fieldset>
