...
<div class="row-fluid">
	...
	<div class="span2 visible-desktop">
		<ul class="nav nav-pills nav-stacked" style="margin-top: 35px;">
			...
			<li>
				<a href="<?php print $this->Html->url(array('controller'=>'ContaPagar','action'=>'index'));?>" onclick="formulario_cancelar(); return false;">
			...
			<li class="active">
				<a href="<?php print $this->Html->url(array('controller'=>'ContaPagar','action'=>'cadastrar'));?>">
					<i class="icon-file"></i>
					Cadastrar
				</a>
			</li>
			<li>
				<a href="<?php print $this->Html->url(array('controller'=>'ContaPagar','action'=>'editar'));?>">
					<i class="icon-edit"></i>
					Editar
				</a>
			</li>
			<li>
				<a href="<?php print $this->Html->url(array('controller'=>'ContaPagar','action'=>'pesquisar'));?>">
					<i class="icon-filter"></i>
					Pesquisar
				</a>
			</li>
			<li>
				<a href="<?php print $this->Html->url(array('controller'=>'ContaPagar','action'=>'index'));?>">
					<i class="icon-list"></i>
					Listar
				</a>
			</li>
	...
	<div class="span10">
		...
		<?php
		if ($this->Ajax->isAjax()) {
			print $this->Ajax->form('cadastrar','post',array('autocomplete'=>'off','model'=>'ContaPagar','update'=>'conteudo_ajax'));

		}
		else {
			print $this->Form->create('ContaPagar',array('autocomplete'=>'off','onsubmit'=>'submissaoFormulario(this); return false;'));
		}
		?>
