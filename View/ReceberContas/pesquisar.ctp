...
<div class="row-fluid">
	<div class="span12">
		<fieldset>
			...
			print $this->Form->input('tipo_documento_id',array('label'=>'Tipo do documento','options'=>$opcoes_tipo_documento,'empty'=>'Selecione'));
			...
			print $this->Form->input('plano_conta_id',array('label'=>'Plano de contas','options'=>$opcoes_plano_contas,'empty'=>'Selecione'));
