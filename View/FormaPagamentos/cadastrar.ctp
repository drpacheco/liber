...
<div class="row-fluid">
	...
	<div class="span12">
		<fieldset>
			<legend class="descricao_cabecalho"><?php print __('Cadastrar forma de pagamento'); ?></legend>
				...
				print $this->Form->input('tipo_documento_id',array('label'=>'Documento','options'=>$opcoes_documentos));
