		...
		<fieldset>
			...
			<div class="row-fluid">
				...
				<div class="span6">
					...
					print $this->Form->input('situacao',array('div'=>false,'label'=>'Situação','options'=>$opcoes_situacoes));
					?>
				</div>
				<div class="span6">
					<?php
					...
					print $this->Form->input('motorista',array('label'=>'Motorista','div'=>false,'options'=>$opcoes_motoristas));
					print $this->Form->input('veiculo',array('label'=>'Veículo','div'=>false,'options'=>$opcoes_veiculos));
					?>
				</div>
