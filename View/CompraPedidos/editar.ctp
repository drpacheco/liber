...
if ($this->Ajax->isAjax()) {
	print $this->Ajax->form('editar','post',array('autocomplete'=>'off','model'=>'CompraPedido','update'=>'conteudo_ajax'));
}
else {
...
<div class="row-fluid">
	...
	<div class="span12">
		...
		<fieldset>
			<legend class="descricao_cabecalho"><?php print __('Editar pedido de compra'); ?></legend>
