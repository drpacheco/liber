...
<div class="row-fluid">
	...
	<div class="span10">
		...
		<?php
		if ($this->Ajax->isAjax()) {
			print $this->Ajax->form('cadastrar','post',array('autocomplete'=>'off','model'=>'Cliente','update'=>'conteudo_ajax'));
		}
		else {
		...
		<fieldset>
			<legend class="descricao_cabecalho"><?php print __('Adicionar Cliente');?></legend>
			<?php
