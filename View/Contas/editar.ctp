<div class="row-fluid">
	...
	<div class="span12">
		<fieldset>
			<legend class="descricao_cabecalho"><?php print __('Editar conta'); ?></legend>
			<?php
			if ($this->Ajax->isAjax()) {
				print $this->Ajax->form('editar','post',array('autocomplete'=>'off','model'=>'DocumentoTipo','update'=>'conteudo_ajax'));
			}
			else {
